    ...
    <div class="container-fluid">
        ...
        <div class="breadcromb-area">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <?php if ($logged_user_type == 1 || has_perm($logged_user_id, 'Setup', 'Ctr', 'Filter')) { ?>
                        <form method="post" action="<?php echo site_url('Setup/contractor_list') ?>">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url('Setup/contractor_list') ?>"><button class="btn btn-primary" type="button">Reset</button></a>
                ...
                <div class="col-lg-2 pull-right">
                    <div class="seipkon-breadcromb-right">
                        <?php if ($logged_user_type == 1 || has_perm($logged_user_id, 'Setup', 'Ctr', 'Add')) { ?>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="wd-30">
                                        <?php if ($logged_user_type == 1 || has_perm($logged_user_id, 'Setup', 'Ctr', 'Edit')) { ?>
                                            <!-- <a href="<?php echo base_url('Setup/view_supplier_dtl?id=') . $value->m_supplier_id; ?>" class="btn btn-info btn-action" title="View" data-toggle="tooltip"><i class="fa fa-eye" aria-hidden="true"></i></a> -->
                                        ...
                                        <?php }
                                        if ($logged_user_type == 1 || has_perm($logged_user_id, 'Setup', 'Ctr', 'Delete')) { ?>
